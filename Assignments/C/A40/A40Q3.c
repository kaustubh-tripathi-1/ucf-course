...
void sortStrings(int words, int length, char str[words][length], int []);
...
void stringsInput(int words, int length, char str[words][length], int lengthOfStrings[])
{
    int i;
...
void sortStrings(int words, int length, char str[words][length], int lengthOfStrings[])
{
    int i, j, order;
