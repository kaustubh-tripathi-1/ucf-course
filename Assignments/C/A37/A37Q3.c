...
int main()
{
    int length, index, indexStart, indexEnd;
    ...
    if( length > 0)
        index = findCharacter( str, indexStart, indexEnd, ch );
    else
    {
...
//@ Finding a character in a string between specified indices
int findCharacter(char str[], int indexStart, int indexEnd, char ch)
{
    int i;
