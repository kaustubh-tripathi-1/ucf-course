...
class Matrix
{
    ...
    public :
        ...
        Matrix addMatrices(const Matrix &m) const
        {
            Matrix result;
            int i, j;
        ...
        Matrix subtractMatrices(const Matrix &m) const
        {
            Matrix result;
            int i, j;
...
int main()
{
    ...
    Matrix add = m1.addMatrices(m2);
    cout<<"Matrix 1 and 2 addition :\n";
    add.displayMatrix();

    Matrix sub = m1.subtractMatrices(m2);
    cout<<"Matrix 1 and 2 subtraction :\n";
    sub.displayMatrix();

    Matrix mult = m1.multiplyMatrices(m2);
